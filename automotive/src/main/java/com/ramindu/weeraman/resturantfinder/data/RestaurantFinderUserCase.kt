...
class RestaurantFinderUserCaseIml() : RestaurantFinderUserCase {
    override suspend fun getRestaurantsNearBy(lon: Double, lat: Double): List<RestaurantItem> {
        ...
        val item1 = RestaurantItem(
            lon = 52.50705869665731,
            lat = 13.389687836618041,
            name = "Green Rabbit",
            address = "Steinstr 2, 12105,Berlin",
            type = "Vegan"
        )
        val item2 = RestaurantItem(
            lon = 52.50720292735356,
            lat = 13.386101039082034,
            name = "Karibisches",
            address = "Steinstr 2, 12105,Berlin",
            type = "Pub & Bar"
        )
        val item3 = RestaurantItem(
            lon = 52.506874648612246,
            lat = 13.393952631095573, name = "Choppaluna",
            address = "Steinstr 2, 12105,Berlin",
            type = "Mexican"
        )

        val item4 = RestaurantItem(
            lon = 52.502089076216656,
            lat = 13.391567074705963, name = "Delhi 6",
            address = "Steinstr 2, 12105,Berlin",
            type = "Indian"
        )

        val item5 = RestaurantItem(
            lon = 52.509145204598006,
            lat = 13.405896994448506, name = "Bocca Felice",
            address = "Steinstr 2, 12105,Berlin",
            type = "Italian"
        )
